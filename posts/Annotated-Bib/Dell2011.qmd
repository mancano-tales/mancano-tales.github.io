...
categories: [Annotated Bibliography, Political Economy, Comparative Politics, Causal Inference, Organized Crime, Network Analysis]
format:
  html:
    toc: true
...
::: {.callout-note collapse="true" icon=false}
## Ficha Analítica — Tabela Interativa
