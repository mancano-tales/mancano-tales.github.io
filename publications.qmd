...
<p>
  <a href="https://orcid.org/0000-0001-5923-9743" target="_blank" rel="noopener" class="btn btn-primary" role="button">
    <i class="bi bi-person-check"></i> View full record on ORCID
  </a>
</p>

<p>
  <a href="https://scholar.google.com/citations?user=UcrcWloAAAAJ&hl=pt-BR" target="_blank" rel="noopener" class="btn btn-outline-primary" role="button">
    <i class="bi bi-mortarboard"></i> View publications on Google Scholar
  </a>
</p>
